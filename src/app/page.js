  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex justify-between gap-1 h-[400px] pt-7">
        <div className="w-1/2">
        <iframe className="w-full h-full" src="https://www.youtube.com/embed/Ap1F6oJO9aM?si=XNGk2Yg2l1rxpEK1" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen loading="lazy"></iframe>
        </div>
        <div className="w-1/2">
